...
async function startServer() {
  ...
  // API route to proxy Cloudflare requests
  ...
  app.get("/api/install", (req, res) => {
    const { accountId, token, model } = req.query;
    ...
    // Dynamically get the public URL where this server is accessed
...
class CloudflareAI:
    def __init__(self, account_id: str, api_token: str):
        ...
        # Menembak ke API buatan kita sendiri (Hono/Express proxy)
...
if __name__ == "__main__":
    ...
    print(f"[*] Mengirim permintaan melalui API Gateway (${appUrl})...")
...
echo -e "\\e[1;36m[*] Menyiapkan environment CFAI API...\\e[0m"
